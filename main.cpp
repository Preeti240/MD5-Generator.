...
void menu () {
    ...
    std::cout << "                                      HACK Community Based Project " << std::endl;

    std::cout << "  \n";

    std::cout << "                                  Welcome to Our System - Hash Cracker Tool \n";
    ...
    std::cout << "\n2) Load Hash to be Cracked " << " [" << hload << "]" << std::endl;

    std::cout << "\n3) Crack Hash" << std::endl;

    std::cout << "\n4) Exit" << std::endl;

    std::cout << "\n\nChose your operation:" << std::endl;
    ...
    switch(choice) {
        case 1:
            std::cout << "\nEnter Dictionary Location (E.g. Text.txt): \n";
            std::cin >> dname;
        ...
        case 2:
            ...
            std::cout << "\nEnter your MD5 Hash to Crack: " << std::endl;
            std::cin >> chash;
